 ...
 * suivant:
 * 
 * Tous les animaux disposent au départ d'un certain nombre de points de
 ...
 * aucune action.
 * Les animaux se déplacent en respectant les mêmes contraintes que les
 * joueurs: le déplacement d'une pièce à une autre n'est possible que s'il
 * existe un passage entre les deux pièces.
 * Les animaux peuvent manger et les pièces peuvent contenir plusieurs types
 ...
 * plusieurs types d'aliment.
 * À l'exception de manger, chaque action de l'animal entraine une
 ...
 * 
 * (1) Ramasser un aliment: l'animal choisit un aliment dans la pièce, l'ajoute
 * à sa réserve, le retire de la piece et diminue son capital de point de vie de
 * la valeur du coût de cette action
 * (2) manger un aliment: l'animal choisit un aliment compatible avec son régime
 * alimentaire parmi ceux qui sont dans sa réserve, le supprime de sa réserve et
 * augmente son capital vie de la valeur nutritive de cet aliment
 * (3) se déplacer: l'animal (ou son maître si l'animal est adoptable et adopté)
 ...
 * 
 * (1) un constructeur ayant pour unique paramètre le nom de l'animal
 * (2) un constructeur à deux arguments: le nom de l'animal et une Collection
 * d'aliments à placer dans sa réserve
 * 
 * 
